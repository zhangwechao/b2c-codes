$(document).ready(function(){
    ...
    $("#aboutus_page").css({"background-image":"url(image/A-dmin-0122.gif)"})
    ...
    $("#btnAdvSearch").bind("click",function(){
        ...
        window.location.href="aboutus.aspx?"+query;
    });
    $("#btnSearch").bind("click",function(){
        var search = $.trim($("#txtSearch").val());
        window.location.href="aboutus.aspx?search="+search;
    });
