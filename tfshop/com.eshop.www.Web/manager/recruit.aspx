<%@ Page Language="C#" MasterPageFile="~/manager/admin.master" AutoEventWireup="true" CodeFile="recruit.aspx.cs" Inherits="back_stage_recruit" Title="在线招聘" %>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#btnSearch").bind("click", function() {
            ...
            window.location.href = "recruit.aspx?title=" + search;
        });
    });
</script>
</asp:Content>
