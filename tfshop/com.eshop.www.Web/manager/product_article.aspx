<%@ Page Title="产品文章" Language="C#" MasterPageFile="~/manager/admin.master" AutoEventWireup="true" CodeFile="product_article.aspx.cs" Inherits="back_stage_product_article" %>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#btnSearch").bind("click", function() {
            ...
            window.location.href = "product_article.aspx?title=" + search;
        });
