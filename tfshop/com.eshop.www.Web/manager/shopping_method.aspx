<%@ Page Language="C#" MasterPageFile="~/manager/admin.master" AutoEventWireup="true" CodeFile="shopping_method.aspx.cs" Inherits="back_stage_shopping_method" Title="运送方式" %>
...
<script type="text/javascript">
    $(document).ready(function() {
        $("#btnSearch").bind("click", function() {
            ...
            window.location.href = "shopping_method.aspx?method=" + search;
        });
    });
</script>
</asp:Content>
...
$("#shopping_method_page").css({ "background-image": "url(image/A-dmin-0122.gif)" });
 ...
 <div id="content" style="clear:both">   
    ...
    <div id="content_head">
        <ul>
            <li>
                以运送方式搜索:<input type="text" id="txtSearch" /></li><li>
