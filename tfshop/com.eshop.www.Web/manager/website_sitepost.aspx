<%@ Page Title="网站公告" Language="C#" MasterPageFile="~/manager/admin.master" AutoEventWireup="true" CodeFile="website_sitepost.aspx.cs" Inherits="back_stage_website_sitepost" %>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#btnAdvSearch").bind("click", function() {
            ...
            window.location.href = "website_sitepost.aspx?" + query;
        });
        $("#btnSearch").bind("click", function() {
            var search = $.trim($("#txtSearch").val());
            window.location.href = "website_sitepost.aspx?title=" + search;
        });
 ...
 <div id="content">   
    ...
    <div id="content_head">
        <ul>
            ...
            <li><input type="button" value="" class="btnRecycle" onclick="window.location.href='news_recycle.aspx'" /></li>        
            <li><input type="button" value="" class="btnReload" onclick="window.location.reload()"/></li>
        </ul>
    </div>
    <div id="page">
