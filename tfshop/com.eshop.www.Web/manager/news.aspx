<%@ Page Title="网站新闻" Language="C#" MasterPageFile="~/manager/admin.master" AutoEventWireup="true" CodeFile="news.aspx.cs" Inherits="back_stage_news" %>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#btnAdvSearch").bind("click", function() {
            ...
            window.location.href = "news.aspx?" + query;
        });
        $("#btnSearch").bind("click", function() {
            var search = $.trim($("#txtSearch").val());
            window.location.href = "news.aspx?title=" + search;
        });
