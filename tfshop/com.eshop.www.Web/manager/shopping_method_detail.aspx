<%@ Page Language="C#" MasterPageFile="~/manager/admin.master" AutoEventWireup="true" CodeFile="shopping_method_detail.aspx.cs" Inherits="back_stage_shopping_method_detail" Title="运送方式 " %>
...
$("#shopping_method_page").css({ "background-image": "url(image/A-dmin-0122.gif)" });
</script>
<div id="content">
...
function validata(){
    ...
    if(validataField.getStrLength(method)>50){
        alert("运送方式字符超过限制，最多50个字符，一个中文两个字符");
        return false;
    }
