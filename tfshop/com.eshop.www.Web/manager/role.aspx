<%@ Page Language="C#" MasterPageFile="~/manager/admin.master" AutoEventWireup="true" CodeFile="role.aspx.cs" Inherits="back_stage_role" Title="角色管理" %>
...
<script type="text/javascript">
    $(document).ready(function() {
        $("#btnSearch").bind("click", function() {
            ...
            window.location.href = "role.aspx?roleName=" + search;
        });
    });
</script>
</asp:Content>
...
$("#role_page").css({ "background-image": "url(image/A-dmin-0122.gif)" });
 ...
 <div id="content" style="clear:both">   
    ...
    <div id="content_head">
        <ul>
            <li>
                以角色名搜索:<input type="text" id="txtSearch" /></li><li>
