<%@ Page Language="C#" MasterPageFile="~/manager/admin.master" AutoEventWireup="true" CodeFile="integrate_purchase.aspx.cs" Inherits="back_stage_integrate_purchase" Title="团购专区" %>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#btnAdvSearch").bind("click", function() {
            ...
            window.location.href = "integrate_purchase.aspx?" + query;
        });
        $("#btnSearch").bind("click", function() {
            var search = $.trim($("#txtSearch").val());
            window.location.href = "integrate_purchase.aspx?title=" + search;
        });
...
$("#integrate_purchase_page").css({ "background-image": "url(image/A-dmin-0122.gif)" });
</script>
 <div id="content">   
