<%@ Page Language="C#" MasterPageFile="~/manager/admin.master" AutoEventWireup="true" CodeFile="payment_method.aspx.cs" Inherits="back_stage_payment_method" Title="付款方式" %>
...
<script type="text/javascript">
    $(document).ready(function() {
        $("#btnSearch").bind("click", function() {
            ...
            window.location.href = "payment_method.aspx?method=" + search;
        });
    });
</script>
</asp:Content>
...
$("#payment_method_page").css({ "background-image": "url(image/A-dmin-0122.gif)" });
 ...
 <div id="content" style="clear:both">   
    ...
    <div id="content_head">
        <ul>
            <li>
                以付款方式搜索:<input type="text" id="txtSearch" /></li><li>
