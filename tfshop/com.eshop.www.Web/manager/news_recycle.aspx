<%@ Page Language="C#" MasterPageFile="~/manager/admin.master" AutoEventWireup="true" CodeFile="news_recycle.aspx.cs" Inherits="back_stage_news_recycle" Title="文章回收站" %>
...
<style type="text/css">
#mytable th,#mytable td{ letter-spacing:normal; padding:6px 6px 3px 3px}
</style>
...
$("#news_recycle_page").css({ "background-image": "url(image/A-dmin-0122.gif)" });
</script>
 <div id="content">   
    ...
    <div id="content_head">
        <ul>
            ...
            <li><asp:Button ID="btnAllRecover" runat="server" Text="" class="btnRecovery"
                    OnClientClick="return ValidataSelect()" onclick="btnAllRecover_Click" /></li>        
            ...
            <asp:Repeater ID="rData" runat="server" onitemcommand="rData_ItemCommand">
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td title='<%#Eval("title") %>' style="cursor:pointer"><%#com.eshop.www.Tools.StringHelper.CutString(Eval("title").ToString(),30) %></td>
                        ...
                        <td>
                            <asp:LinkButton ID="btnUpdate" runat="server" Text="恢复" CommandName="recover" CommandArgument='<%#Eval("Id") %>' />
