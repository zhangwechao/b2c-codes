<%@ Page Title="在线帮助" Language="C#" MasterPageFile="~/manager/admin.master" AutoEventWireup="true" CodeFile="help.aspx.cs" Inherits="back_stage_help" %>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#btnAdvSearch").bind("click", function() {
            ...
            window.location.href = "help.aspx?" + query;
        });
        $("#btnSearch").bind("click", function() {
            var search = $.trim($("#txtSearch").val());
            window.location.href = "help.aspx?title=" + search;
        });
 ...
 <div id="content">   
    ...
    <div id="content_head">
        <ul>
            ...
            <li><input type="button" value="" onclick="window.location='news_category.aspx?type=help'" class="categoryManage" /></li>        
