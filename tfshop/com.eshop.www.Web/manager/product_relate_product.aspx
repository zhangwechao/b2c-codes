<%@ Page Title="" Language="C#" MasterPageFile="~/manager/admin.master" AutoEventWireup="true" CodeFile="product_relate_product.aspx.cs" Inherits="back_stage_product_relate_product" %>
...
<script type="text/javascript">
    $(document).ready(function() {
        $("#btnSearch").bind('click', function() {
            ...
            window.location.href = 'product_relate_product.aspx?productId='+productId+'&productName='+title;
        });
        ...
        <table id="inputTable">
            <tr>
                <td colspan="2" align="left" class="inputTableTd">
                    搜索产品：<input type="text" id="txtSearch" />&nbsp;
            ...
            <tr>
                ...
                <td class="inputTableTd">
                    当前<font color='red'><asp:Literal ID="lProductName" runat="server"></asp:Literal></font>已相关产品
                </td>
            </tr>
            <tr>
                        ...
                        <asp:Repeater ID="rRelate" runat="server" onitemcommand="rRelate_ItemCommand">
                            ...
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td title='<%#Eval("product_name") %>' style="cursor:pointer"><%#com.eshop.www.Tools.StringHelper.CutString(Eval("product_name").ToString(),50) %></td>
                                    <td>
