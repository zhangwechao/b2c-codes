<%@ WebHandler Language="C#" Class="law_statement" %>
...
public class law_statement : IHttpHandler
{
    ...
    private void Export()
    {
        ...
        string sql = "select title,summary,content,keywords from news_content where is_delete=0 and category_id=6";
