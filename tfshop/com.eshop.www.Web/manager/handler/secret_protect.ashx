<%@ WebHandler Language="C#" Class="secret_protect" %>
...
public class secret_protect : IHttpHandler
{
    ...
    private void Export()
    {
        ...
        string sql = "select title,summary,content,keywords from news_content where is_delete=0 and category_id=5";
