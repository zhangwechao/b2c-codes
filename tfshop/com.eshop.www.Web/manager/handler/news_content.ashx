<%@ WebHandler Language="C#" Class="news_content" %>
...
public class news_content : IHttpHandler {
    ...
    private void Export()
    {
        ...
        string sql = "select title,summary,content,keywords from news_content where is_delete=0 and category_id=4";
