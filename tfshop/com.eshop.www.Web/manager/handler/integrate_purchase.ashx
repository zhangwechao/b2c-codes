<%@ WebHandler Language="C#" Class="integrate_purchase" %>
...
public class integrate_purchase : IHttpHandler
{
    ...
    private void Export()
    {
        ...
        string sql = "select title,summary,content,keywords from news_content where is_delete=0 and category_id=7";
