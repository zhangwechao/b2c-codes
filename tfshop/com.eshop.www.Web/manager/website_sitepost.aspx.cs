...
public partial class back_stage_website_sitepost : System.Web.UI.Page
{
    ...
    private void rData_bind()
    {
        ...
        where.Append(" category_id=4 and is_delete=0");
    ...
    protected void rData_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
        ...
        {
            case "update":
                Response.Redirect("news_content_detail.aspx?Id=" + id + "&action=update&type=sitepost");
                break;
            case "delete":
    ...
    {
        Response.Redirect("news_content_detail.aspx?type=sitepost");
    }
