...
public partial class back_stage_product_article : System.Web.UI.Page
{
    ...
    private void rData_bind()
    {
        ...
        string fieldList = "Id,title,click_number,order_by,is_show,create_date";
        string orderField = "order_by";
        bool orderBy = true;
        table = new ProductArticleBusiness().GetList(fieldList, orderField, orderBy, AspNetPager1.CurrentPageIndex, AspNetPager1.PageSize, where.ToString());
    ...
    protected void rData_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
        ...
        {
            case "update":
                Response.Redirect("product_article_detail.aspx?Id=" + id + "&action=update");
                break;
            case "delete":
    ...
    {
        Response.Redirect("product_article_detail.aspx");
    }
