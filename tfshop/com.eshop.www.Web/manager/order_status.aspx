<%@ Page Language="C#" MasterPageFile="~/manager/admin.master" AutoEventWireup="true" CodeFile="order_status.aspx.cs" Inherits="back_stage_order_status" Title="订单状态" %>
...
<script type="text/javascript">
    $(document).ready(function() {
        $("#btnSearch").bind("click", function() {
            ...
            window.location.href = "order_status.aspx?status=" + search;
        });
    });
</script>
</asp:Content>
...
$("#order_status_page").css({ "background-image": "url(image/A-dmin-0122.gif)" });
 ...
 <div id="content" style="clear:both">   
    ...
    <div id="content_head">
        <ul>
            <li>
                以订单状态搜索:<input type="text" id="txtSearch" /></li><li>
