<%@ Page Language="C#" MasterPageFile="~/manager/admin.master" AutoEventWireup="true" CodeFile="news_category.aspx.cs" Inherits="administrator_news_category" Title="文章目录" %>
...
<style type="text/css">
#content_left{float:left; width:180px; clear:left;}
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#btnSearch").bind("click", function() {
            ...
            window.location.href = "news_category.aspx?categoryName=" + search+"&type="+type;
        });
        ...
        $("#btnAdvSearch").bind("click", function() {
            ...
            window.location.href = "news_category.aspx?" + query+"&type="+type;
        });
...
if (type == "help")
    ...
    <table>
        ...
        <tr>
            <td colspan="2" align="center">
                <input type="button" value="开始搜索" id="btnAdvSearch" onclick="advSearch()" />
            </td>
        </tr>
    </table>
</div>
 <div id="content">   
    ...
    <div id="content_head">
        <ul>
            <li>
                以目录名搜索:<input type="text" id="txtSearch" />
                </li>
                <li>
                <input type="button" id="btnSearch" value=""  class="btnReload"/>
            </li>
            ...
            <asp:Repeater ID="rData" runat="server" onitemcommand="rData_ItemCommand">
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td>
                            <asp:Button ID="btnUpdate" runat="server" Text="修改" CommandName="update" CommandArgument='<%#Eval("Id") %>' />&nbsp;
